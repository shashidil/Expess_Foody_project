...
<head>
    ...
    if(isset($_POST["upd_item"])){
        ...
        WHERE c_id = {$target_cid} AND f_id = {$target_fid}";
    ...
    <title>Food Item | Pizza World</title>
</head>
    ...
    <div class="row my-4">
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            ...
            <div class="col text-wrap">
                ...
                <?php
                    $ci_query = "SELECT ct_amount,ct_note FROM cart WHERE c_id = {$_SESSION['cid']} AND f_id = {$f_id} ";
                ...
                <div class="form-amount">
                    <form class="mt-3" method="POST" action="cust_update_cart.php">
                        ...
                        <div class="d-grid gap-2 d-md-block">
                            ...
                            <button class="btn btn-outline-danger" type="submit" formaction="remove_cart_item.php?rmv=1&f_id=<?php echo $f_id?>" value="rmv" title="remove from cart" name="rmv_item">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
