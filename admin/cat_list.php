...
<head>
    ...
    <title>Shop category Menu List | Express Food Meal Restaurant</title>
</head>
            ...
            <form class="form-floating mb-3" method="GET" action="shop_menu_list.php">
                <div class="row g-2">
                    ...
                    <div class="col-auto">
                        ...
                        <a href="shop_menu_add.php" class="btn btn-primary">Add new category</a>
                    </div>
                </div>
            </form>
        </div>
    <div class="pt-2" id="cust-table">
        ...
        <?php
            if(!isset($_GET["search"])){
                ...
                $search_query = "SELECT * FROM food f WHERE f_name LIKE '%{$search_fn}%';";
            }
