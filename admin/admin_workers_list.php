        ...
        <div class="mt-4 border-bottom">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Successfully updated worker profile.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_workers_list.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    ...
                    </svg><span class="ms-2 mt-2">Failed to update worker profile.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_workers_list.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Successfully deleted Workers profile.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_workers_list.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <path
                            d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                    </svg><span class="ms-2 mt-2">Failed to delete worker profile.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_workers_list.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Successfully add new worker profile.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_workers_list.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <path
                            d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                    </svg><span class="ms-2 mt-2">Failed to add new worker profile.</span>
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_workers_list.php">X</a></span>
                </div>
            </div>
            ...
            <h2 class="pt-3 display-6">Worker List</h2>
            <form class="form-floating mb-3" method="GET" action="admin_workers_list.php">
                <div class="row g-2">
                    <div class="col">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="firstname" name="fn" placeholder="Name"
                    ...
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger"
                            onclick="javascript: window.location='admin_workers_list.php'">Clear</button>
                        
                <a href="admin_workers_add.php" class="btn btn-primary">Add new Worker</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="container pt-2" id="cust-table">
        ...
        <?php
            if(!isset($_GET["search"])){
                $search_query = "SELECT a_id,username,name,type,email FROM admin;";
            }else{
                $search_un=$_GET["un"];
                $search_fn=$_GET["fn"];
                $search_ln=$_GET["ln"];
                // $search_ut=$_GET["ut"];
                $search_query = "SELECT a_id,username,name,type,email FROM admin
                WHERE username LIKE '%{$search_un}%' AND name LIKE '%{$search_fn}%'; ";
        ...
        <div class="row">
            <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <path
                        d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                </svg><span class="ms-2 mt-2">No worker found!</span>
                <a href="admin_workers_list.php" class="text-white">Clear Search Result</a>
            </div>
        </div>
        <?php } else{ ?>
        <div class="table-responsive">
        <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
            <caption><?php echo $search_numrow;?> worker(s) <?php if(isset($_GET["search"])){?><br /><a
                    href="admin_workers_list.php" class="text-decoration-none text-danger">Clear Search
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="admin_workers_detail.php?a_id=<?php echo $row["a_id"]?>"
                            class="btn btn-sm btn-primary">View</a>
                        <a href="admin_workers_delete.php?a_id=<?php echo $row["a_id"]?>"
