...
<head>
    ...
    <title>Customer Order List | Express Food Meal Restaurant</title>
</head>
    ...
    <div class="container px-5 pt-4" id="shop-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active p-3" id="nav-acpt" role="tabpanel" aria-labelledby="acpt-tab">
                <?php
                $acpt_query = "SELECT * FROM order_header WHERE orh_orderstatus = 'ACPT' ORDER BY orh_pickuptime ASC;";
            ...
            <div class="tab-pane fade p-3" id="nav-prep" role="tabpanel" aria-labelledby="prep-tab">
                <?php
                $acpt_query = "SELECT * FROM order_header WHERE orh_orderstatus = 'PREP' ORDER BY orh_pickuptime ASC;";
                $acpt_result = $mysqli -> query($acpt_query);
                $acpt_num = $acpt_result -> num_rows;
                if($acpt_num>0){
                ?>
            ...
            <div class="tab-pane fade p-3" id="nav-rdpk" role="tabpanel" aria-labelledby="rdpk-tab">
                <?php
                $acpt_query = "SELECT * FROM order_header WHERE orh_orderstatus = 'RDPK' ORDER BY orh_pickuptime ASC;";
                $acpt_result = $mysqli -> query($acpt_query);
                $acpt_num = $acpt_result -> num_rows;
                if($acpt_num>0){
                ?>
            ...
            <div class="tab-pane fade p-3" id="nav-fnsh" role="tabpanel" aria-labelledby="fnsh-tab">
                <?php
                $acpt_query = "SELECT * FROM order_header WHERE orh_orderstatus = 'FNSH' ORDER BY orh_finishedtime DESC;";
                $acpt_result = $mysqli -> query($acpt_query);
                $acpt_num = $acpt_result -> num_rows;
                if($acpt_num>0){
                ?>
