...
<head>
    <?php
        ...
        if(isset($_POST["add_confirm"])){
            ...
            $insert_query = "INSERT INTO food (f_name,f_price,f_todayavail,f_preorderavail)
            VALUES ('{$f_name}',{$f_price},{$f_todayavail},{$f_preorderavail});";
    ...
    <title>Shop Add Menu | Express Food Meal Restaurant</title>
</head>
